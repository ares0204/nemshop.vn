...
<body>
            ...
            <div class="header__navbar-menu grid__column-10">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
                        <a href="#" class="header__navbar-item-link">SẢN PHẨM<i class="header__navbar-item-link-icon fa-solid fa-angle-down"></i></a>
                        <div class="header__navbar-sub-item">
                            <ul class="header__navbar-sub-item-list">
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="#" class="header__navbar-sub-item-list-item-link">Áo kiểu</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="#" class="header__navbar-sub-item-list-item-link">Set bộ</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="#" class="header__navbar-sub-item-list-item-link">Áo dài</a>
                                </li>
                            </ul>
                        </div>
                    </li>
    ...
    <div class="search">
        <div class="grid__column-9 search">
            <form class="search__form" method="GET" action="">
                <input class="search__input" type="text" name="search" placeholder="Nhập từ khóa tìm kiếm">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "
                                    ...
                                    <a href='./product/item1.php' class='collections__product-item-link'>
