                    ...
                    <div class="collections__product">
                        <div class="gird__row grid__flex">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                if ($row['classifyName'] == 'ÁO KIỂU') {
                                    echo "<div class='collections__product-heading'>" . $row['classifyName'] . "</div>";
                                }
                            }
                            // Đóng kết nối
                            mysqli_close($conn);
                            ...
                            <ul class="collections__product-select">
                                ...
                                <li class="collections__product-select-item">Giá<i class="collections__product-select-item-icon fa-solid fa-caret-down"></i></li>
                            </ul>
                        </div>
                        <div class="grid__row">
