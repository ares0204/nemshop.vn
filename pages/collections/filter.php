...
<head>
    ...
    <title>TẤT CẢ SẢN PHẨM - NEW FASHION</title>
            ...
            <div class="header__navbar-menu grid__column-10">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
                        <a href="./All.php" class="header__navbar-item-link">SẢN PHẨM<i class="header__navbar-item-link-icon fa-solid fa-angle-down"></i></a>
                        <div class="header__navbar-sub-item">
                            <ul class="header__navbar-sub-item-list">
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="./ao-kieu.php" class="header__navbar-sub-item-list-item-link">Áo kiểu</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="./set-bo.php" class="header__navbar-sub-item-list-item-link">Set bộ</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="./ao-dai.php" class="header__navbar-sub-item-list-item-link">Áo dài</a>
                                </li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="grid">
            <div class="grid__row">
                <div class="grid__column-3">
                    <div class="collections__categories">
                        <div class="collections__categories-heading">Danh mục</div>
                        <ul class="collections__categories-list">
                            <li class="collections__categories-item">
                                <a href="./All.php" class="collections__categories-item-link">Tất cả danh mục</a>
                            </li>
                            <li class="collections__categories-item">
                                <a href="./ao-kieu.php" class="collections__categories-item-link">Áo kiểu</a>
                            </li>
                            <li class="collections__categories-item">
                                <a href="./set-bo.php" class="collections__categories-item-link">Áo bộ</a>
                            </li>
                            <li class="collections__categories-item">
                                <a href="./ao-dai.php" class="collections__categories-item-link">Áo dài</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="grid__column-9">
                    <div class="collections__product">
                        <div class="gird__row grid__flex">
                            <div class="collections__product-heading">LỌC SẢN PHẨM</div>
                            <ul class="collections__product-select">
                                <li class="collections__product-select-item">Kích cỡ<i class="collections__product-select-item-icon fa-solid fa-caret-down"></i></li>
                                <li class="collections__product-select-item">Màu sắc<i class="collections__product-select-item-icon fa-solid fa-caret-down"></i></li>
                                <li class="collections__product-select-item">
                                    Giá<i class="collections__product-select-item-icon fa-solid fa-caret-down"></i>

                                    <div class="collections__product-select-sub-item">
                                        <form action="filter.php" method="POST">
                                            <label for="price">Giá tối đa:</label>
                                            <input type="number" name="price" id="price">
                                            <input class="collections__product-select-sub-item-btn" type="submit" value="Lọc">
                                        </form>
                                    </div>
                        ...
                        <div class="grid__row">
                            <ul class="collections__product-list">
                                <?php
                                ...
                                // Xây dựng câu truy vấn SQL dựa trên tiêu chí lọc
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "
                                            <li class='collections__product-item'>
                                            <a href='../product/item" . $row['id'] . ".php' class='collections__product-item-link'>
                                                <img src='" . $row['img'] . "' alt='' class='collections__product-item-img'>
                                                <div class='collections__product-item-name'>" . $row['name'] . "</div>
                                                <div class='collections__product-item-sub'>
                                                    <button class='collections__product-item-sub-btn'>
                                                        XEM THÊM
                                                    </button>
                                                </div>
                                            </a>
                                            <span class='collections__product-item-price'>" . $row['price'] . "₫</span>
                                            </li>
                                        ";
                                    }
                                } else {
