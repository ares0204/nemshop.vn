...
<body>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__content grid">
            ...
            <span>/</span>
            <span>GIỎ HÀNG CỦA BẠN - NEM FASHION</span>
        </div>
    </div>
            ...
            <form action="" class="cart__form">
                <table class="cart__table">
                    <thead class="cart__table-header">
                        <tr>
                            <th></th>
                            <th class="cart__table-header-title">Sản phẩm</th>
                            <th class="cart__table-header-title">Giá</th>
                            <th class="cart__table-header-title">Số lượng</th>
                            <th class="cart__table-header-title">Tổng tiền</th>
                        </tr>
                    </thead>
                    <tbody class="cart__table-content">
                        <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "
                                <tr>
                                    <td class='cart__table-content-img'>
                                        <img style='width: 100%;' src='" . $row['img'] . "' alt='' class=''>
                                    </td>
                                    <td class='cart__table-content-title'>
                                        <span class='cart__table-content-title-name'>
                                            " . $row['name'] . "
                                            <a class='cart__table-content-remove' href='../components/removeFromCart.php?id=".$row['id']."'>Xóa</a>
                                        </span>
                                    </td>
                                    <td class='cart__table-content-price'>
                                        <span class='cart__table-content-price-text'>
                                            " . $row['price'] . "₫
                                        </span>
                                    </td>
                                    <td class='cart__table-content-quantity'>
                                        <input type='number' class='cart__table-content-quantity-input' value='" . $row['quantity'] . "'>
                                    </td>
                                    <td class='cart__table-content-total'>
                                        <span class='cart__table-content-total-text'>
                                            ...
                                        </span>
                                    </td>
                                </tr>        
                ...
                <div class="grid">
                    <div class="grid__row">
                        <div class="grid__column-8">
                            <span class="cart__note-title">Chú thích</span>
                            <textarea name="" id="" cols="30" rows="10" class="cart__note"></textarea>
                        </div>
                        <div class="grid__column-4">
                            <div class="cart__total">
                                ...
                                <span class="cart__total-text">
                                    459,000₫
                                </span>
                            </div>
                            <div class="cart__btn">
                                <input type="submit" class="cart__btn-update" value="CẬP NHẬT">
                                <input type="submit" class="cart__btn-buy" value="THANH TOÁN">
                            </div>
                        </div>
                    </div>
                </div>
