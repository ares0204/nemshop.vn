...
<head>
    ...
    <title>Áo len cộc tay 459 - NEM FASHION</title>
...
<body>
    <header class="header">
        ...
        <nav class="header__navbar grid">
            <div class="header__navbar-logo grid__column-2-4">
                <a href="/nemshop.vn-demo/index.php" class="header__navbar-logo-link">
            ...
            <div class="header__navbar-menu grid__column-10">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
                        <a href="../collections/All.php" class="header__navbar-item-link">SẢN PHẨM<i class="header__navbar-item-link-icon fa-solid fa-angle-down"></i></a>
                        <div class="header__navbar-sub-item">
                            <ul class="header__navbar-sub-item-list">
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="../collections/ao-kieu.php" class="header__navbar-sub-item-list-item-link">Áo kiểu</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="../collections/set-bo.php" class="header__navbar-sub-item-list-item-link">Set bộ</a>
                                </li>
                                <li class="header__navbar-sub-item-list-item">
                                    <a href="../collections/ao-dai.php" class="header__navbar-sub-item-list-item-link">Áo dài</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="header__navbar-search">
                    ...
                    <div class="header__navbar-sub-search">
                        <input type="text" class="header__navbar-sub-search-input" placeholder="Tìm kiếm..." />
                        <button class="header__navbar-sub-search-btn">
                            <i class="header__navbar-search-icon fa-solid fa-magnifying-glass"></i>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="header__navbar-sub-account">
                        <ul class="header__navbar-sub-account-list">
                            <li class="header__navbar-sub-account-item">
                                <a href="../authen.php" class="header__navbar-sub-account-item-link">Đăng nhập</a>
                            </li>
                            <li class="header__navbar-sub-account-item">
                                <a href="../authen.php" class="header__navbar-sub-account-item-link">Đăng ký</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="header__navbar-cart">
                    <a href="../cart.php" class="header__navbar-cart-link">
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__content grid">
            <a href="../../index.php" class="breadcrumb__content-home">TRANG CHỦ</a>
            <span>/</span>
            <a href="../collections.php" class="breadcrumb__content-home">TẤT CẢ SẢN PHẨM</a>
            <span>/</span>
            <span>ÁO LEN CỔ BẺ AL62092</span>
        </div>
    </div>
            ...
            <div class="grid__row">
                    ...
                    <div class="content__img">
                        <div class="grid__row">
                            <div class="grid__column-3">
                                <div class="content__img-small">
                                    <ul class="content__img-small-list">
                                        <?php
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "
                                                <li class='content__img-small-item'>
                                                    <img class='content__img-small-item-img content__img-small-item-img--active' src='" . $row['img'] . "' alt='' onclick='showLargeImage(\"" . $row['img'] . "\")'>
                                                </li>
                                                <li class='content__img-small-item'>
                                                    <img class='content__img-small-item-img' src='" . $row['img1'] . "' alt='' onclick='showLargeImage(\"" . $row['img1'] . "\")'>
                                                </li>
                                                <li class='content__img-small-item'>
                                                    <img class='content__img-small-item-img' src='" . $row['img2'] . "' alt='' onclick='showLargeImage(\"" . $row['img2'] . "\")'>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class='grid__column-9'>
                                        <div class='content__img-big'>
                                            <img src='" . $row['img'] . "' alt='' class='content__img-big-img'>
                                            ";
                                        }
                                        $connect->close();
                                        ?>
                ...
                <div class="grid__column-4">
                    <div class="content__info">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "
                                <div class='content__info-name' name='name'>" . $row['name'] . "</div>
                                <span class='content__info-desc'>Thương hiệu: NEM</span>
                                <span class='content__info-desc'>Mã SP: " . $row['id'] . "</span>
                                <span class='content__info-price' name='price'>" . $row['price'] . "₫</span>
                            ";
                        }

                        $connect->close();
                        ?>
                        <span class="content__info-title">Kích thước</span>
                        <a href="#" class="content__info-size-btn">Size 4</a>
                        <a href="#" class="content__info-size-btn">Size 6</a>
                        <span class="content__info-title">Màu sắc</span>
                        ...
                        <!-- Add to cart -->
                        <form action="../../components/addToCart.php?id=6" method="post">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "
                                <span class='content__info-title'>Chất liệu:</span>
                                <span class='content__info-desc'>" . $row['material'] . "</span>
                                <span class='content__info-title'>Kiểu dáng:</span>
                                <span class='content__info-desc'>" . $row['designs'] . "</span>
                                <span class='content__info-title'>Sản phẩm thuộc dòng sản phẩm:</span>
                                <span class='content__info-desc'>NEM NEW</span>
                                <span class='content__info-title'>Thông tin người mẫu:</span>
                                <span class='content__info-desc'>cao 1m60, nặng 50kg, số đo 84 - 64 - 90 mặc sản phẩm size 2</span>
                                <span class='content__info-title'>Sản phẩm kết hợp:</span>
                                <span class='content__info-desc'>" . $row['pair'] . "</span>
                            ";
                        }
